...
const LeftSide = ({ setIsModalOpen, setIsSidePanelOpen, isSidePanelOpen, project,message , setMessage ,send ,messageBox}) => {
    ...
    return (
        ...
        <section className="left relative flex flex-col h-screen min-w-96 bg-slate-300">
            ...
            <div className="conversation-area relative pt-14 pb-10 flex-grow flex flex-col h-screen bg-cover bg-center" 
                 style={{ backgroundImage: "url('https://source.unsplash.com/800x600/?chat,technology')" }}>
                <div ref={messageBox} 
                     className="message-box p-3 flex-grow flex flex-col gap-2 overflow-auto max-h-full scrollbar-hide bg-opacity-70 backdrop-blur-md"> 
